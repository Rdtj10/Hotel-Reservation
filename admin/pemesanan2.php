...
?>
			...
			<table width="380px">
			<tr align="center">
                <td class="table" colspan="2" style="width:300px;"><img src="../simpangambar/<?php echo $gambarxy?>" width='200px' height='150px' style="border:5px solid #B40301;"></td>
			</tr>
			<tr>
				<td class="table">Tipe Kamar</td>
				<td class="table">
			...
			<tr>
                <td class="table"class="table"  >Harga / Malam</td>
				<td class="table"><input type="text" name="harga" readonly="true" value="<?php echo $hargaxy ?>">
				<input type="hidden" name="stok" readonly="true" value=" <?php echo $stokyx ?>"></td>
			</tr>
			<tr>
				<td class="table">Jumlah Kamar</td>
				<td class="table">
			...
			<tr>
				<td class="table">Nama Lengkap</td>
				<td class="table"><input type="text" name="nama" value="<?php echo $nama ?>">
					<input type="hidden" name="idtamu" readonly="true" value="<?php echo $id ?>"></td>
			</tr>
			<tr>
				<td class="table">Alamat</td>
				<td class="table"><input type="text" name="alamat" value="<?php echo $alamat?>"></td>
			</tr>
			<tr>
				<td class="table">No. Telepon</td>
				<td class="table"><input type="text" name="telepon" value="<?php echo $telepon ?>"></td>
			</tr>
			<tr>
				<td class="table">Tanggal Check-In</td>
				<td class="table"><input type="date" value="<?php echo $in ?>" min="<?php echo date('d-m-Y') ?>" required="required" onchange="hitung()" name="tglcekin" style="font-family: arial"></td>
			</tr>
			<tr>
				<td class="table">Tanggal Check-Out</td>
				<td class="table"><input type="date" value="<?php echo $out ?>" required="required" onchange="hitung()"  name="tglcekout" style="font-family: arial"></td>
			</tr>
			<tr>
				<td class="table">Lama Menginap</td>
				<td class="table"><input type="text" name="lama" onchange="hitung()" readonly="true" style="width: 100px;"> Malam</td>
			</tr>
			<tr>
				<td class="table">Total Biaya</td>
				<td class="table"><input type="text" name="total" onchange="hitung()" readonly="true"></td>
			</tr>
			<tr>
				<td class="table"></td>
				<td class="table"><button type="submit" style="width:100px;background:#B40301; color:white;font-weight:bold;padding:5px;border:2px solid #B40301;">Pesan Kamar</button></td>
			</tr>
		</table>
		</form>
<?php 
...
?>
			...
			<table width="380px">
			<tr align="center">
				<td class="table"colspan="2" style="width:300px;"><img src="../simpangambar/<?php echo $gambar?>" width='200px' height='150px' style="border:5px solid #B40301;"></td>
			</tr>
			<tr>
				<td class="table">Tipe Kamar</td>
				<td class="table">
			...
			<tr>
				<td class="table">Harga / Hari</td>
				<td class="table"><input type="text" name="harga" readonly="true" value="<?php echo $harga ?>">
			...
			<tr>
				<td class="table">Nama Lengkap</td>
				<td class="table"><input type="text" name="nama" requied="required"></td>
			</tr>
			<tr>
				<td class="table">Alamat</td>
				<td class="table"><input type="text" name="alamat" requied="required"></td>
			</tr>
			<tr>
				<td class="table">No. Telepon</td>
				<td class="table"><input type="text" name="telepon" requied="required"></td></td>
			</tr>
			<tr>
				<td class="table">Tanggal Check-In</td>
				<td class="table"><input type="date" min="<?php echo date('d-m-Y') ?>" required="required" onchange="hitung()" name="tglcekin" style="font-family: arial"></td>
			</tr>
			<tr>
				<td class="table">Tanggal Check-Out</td>
				<td class="table"><input type="date" required="required" onchange="hitung()" name="tglcekout" style="font-family: arial"></td>
			</tr>
			<tr>
				<td class="table">Lama Menginap</td>
				<td class="table"><input type="text" name="lama" onchange="hitung()" readonly="true" style="width: 100px;"> Malam</td>
